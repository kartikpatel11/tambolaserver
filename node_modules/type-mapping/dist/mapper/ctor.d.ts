...
/**
    ...
    TODO Handle `name`?
*/
export declare function mapper<OutputF extends AnyExtendedMapper>(f: (ExtendedMapper<HandledInputOf<OutputF>, OutputOf<OutputF>, ExtraParamsOf<OutputF>>)): (OutputF);
