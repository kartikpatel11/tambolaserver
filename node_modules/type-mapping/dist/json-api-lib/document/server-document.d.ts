...
import { __DocumentConstraintImpl } from "./__document-constraint-impl";
 ...
 *  @see {@link serverDocument}
 */
export declare type ServerDocument<ArgsT extends DocumentArgs> = (ServerDocumentBase & __DocumentConstraintImpl<ArgsT & {
 ...
 *  @see {@link serverDocument}
 */
export declare type ExpectedInputServerDocument<ArgsT extends DocumentArgs> = (ExpectedInputServerDocumentBase & __DocumentConstraintImpl<ArgsT & {
 ...
 *  @see {@link serverDocument}
 */
export declare type MappableInputServerDocument<ArgsT extends DocumentArgs> = (MappableInputServerDocumentBase & __DocumentConstraintImpl<ArgsT & {
    errorObject: ExpectedInputErrorObject;
    resource: ExpectedInputServerResource;
}>);
/**
 *  @see {@link serverDocument}
 */
export declare type ServerDocumentMapper<ArgsT extends DocumentMapperArgs> = (FluentMapper<SafeMapper<ServerDocument<ToDocumentArgs<ArgsT>>> & ExpectedInput<ExpectedInputServerDocument<ToExpectedInputDocumentArgs<ArgsT>>> & MappableInput<MappableInputServerDocument<ToMappableInputDocumentArgs<ArgsT>>>>);
/**
 ...
 */
export declare function serverDocument<ArgsT extends DocumentMapperArgs>(args: ArgsT): (ServerDocumentMapper<ArgsT>);
//# sourceMappingURL=server-document.d.ts.map