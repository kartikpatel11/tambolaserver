...
export interface IRoute<DataT extends RouteData> {
    voidHandler<ReturnT extends void | undefined = void | undefined>(handler: __RequestVoidHandler<DataT, ReturnT>): (IRoute<DataT>);
    /**
        If passing a function literal,
        you'll probably need to specify `NextLocalsT`
        as TS will not be able to infer it properly.
    */
    valueHandler<NextLocalsT extends Locals, ReturnT extends void | undefined = void | undefined>(handler: __RequestValueHandler<DataT, NextLocalsT, ReturnT>): (IRoute<{
        request: DataT["request"];
        response: {
            locals: (DataT["response"]["locals"] & NextLocalsT);
            json: DataT["response"]["json"];
        };
    }>);
    asyncVoidHandler<ReturnT extends Promise<void | undefined> = Promise<void | undefined>>(handler: __AsyncRequestVoidHandler<DataT, ReturnT>): (IRoute<DataT>);
    asyncValueHandler<NextLocalsT extends Locals>(handler: AsyncRequestValueHandler<DataT, NextLocalsT>): (IRoute<{
        request: DataT["request"];
        response: {
            locals: (DataT["response"]["locals"] & NextLocalsT);
            json: DataT["response"]["json"];
