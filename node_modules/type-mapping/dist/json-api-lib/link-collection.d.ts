...
import { Link, ExpectedInputLink } from "./link";
/**
 ...
 */
export declare const linkCollection: (() => FluentMapper<SafeMapper<LinkCollection> & ExpectedInput<ExpectedInputLinkCollection>>);
//# sourceMappingURL=link-collection.d.ts.map