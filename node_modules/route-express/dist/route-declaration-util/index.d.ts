...
export declare type RouteDataOf<DataT extends rd.RouteData, LocalsT> = ({
    readonly request: {
    ...
    readonly response: {
        ...
        readonly json: rd.RouteUtil.ServerExpectedResponse<DataT> extends never ? never : (response: rd.RouteUtil.ServerExpectedResponse<DataT>) => (Response<RouteDataOf<DataT, LocalsT>["response"]>);
    };
});
