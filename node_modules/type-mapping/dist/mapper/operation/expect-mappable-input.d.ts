...
export declare type ExpectMappableInput<F extends AnyMapper> = (Mapper<HandledInputOf<F>, OutputOf<F>> & ExpectedInput<MappableInputOf<F>> & MappableInput<MappableInputOf<F>> & ExtractRunTimeModifierOrUnknown<F>);
/**
...
*/
export declare function expectMappableInput<F extends AnyMapper>(f: F): (ExpectMappableInput<F>);
//# sourceMappingURL=expect-mappable-input.d.ts.map