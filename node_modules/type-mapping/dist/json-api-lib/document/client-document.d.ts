 ...
 *  @see {@link clientDocument}
 */
export declare type ClientDocument<ArgsT extends DocumentArgs> = (ClientDocumentBase & __DocumentConstraintImpl<ArgsT & {
 ...
 *  @see {@link clientDocument}
 */
export declare type ExpectedInputClientDocument<ArgsT extends DocumentArgs> = (ExpectedInputClientDocumentBase & __DocumentConstraintImpl<ArgsT & {
 ...
 *  @see {@link clientDocument}
 */
export declare type MappableInputClientDocument<ArgsT extends DocumentArgs> = (MappableInputClientDocumentBase & __DocumentConstraintImpl<ArgsT & {
    errorObject: ExpectedInputErrorObject;
    resource: ExpectedInputClientResource;
}>);
/**
 *  @see {@link clientDocument}
 */
export declare type ClientDocumentMapper<ArgsT extends DocumentMapperArgs> = (FluentMapper<SafeMapper<ClientDocument<ToDocumentArgs<ArgsT>>> & ExpectedInput<ExpectedInputClientDocument<ToExpectedInputDocumentArgs<ArgsT>>> & MappableInput<MappableInputClientDocument<ToMappableInputDocumentArgs<ArgsT>>>>);
/**
 ...
 */
export declare function clientDocument<ArgsT extends DocumentMapperArgs>(args: ArgsT): (ClientDocumentMapper<ArgsT>);
//# sourceMappingURL=client-document.d.ts.map