...
/**
    ...
    ```
*/
export declare type IsPipeable<FromF extends AnyMapper, ToF extends AnyMapper> = (ToF extends Mapper<infer HandledInputT, any> ? (unknown extends HandledInputT ? true : OutputOf<FromF> extends MappableInputOf<ToF> ? true : false) : false);
/**
    ...
    @see IsPipeable
*/
export declare type AssertPipeable<FromF extends AnyMapper, ToF extends AnyMapper> = (IsPipeable<FromF, ToF> extends true ? ToF : [OutputOf<FromF>, "does not extend", MappableInputOf<ToF>]);
//# sourceMappingURL=is-pipeable.d.ts.map