 ...
 *  @see {@link clientDocument}
 */
export declare type NonErrorClientDocument<ArgsT extends DocumentArgs> = (NonErrorClientDocumentBase & __NonErrorDocumentConstraintImpl<ArgsT & {
 ...
 *  @see {@link clientDocument}
 */
export declare type ExpectedInputNonErrorClientDocument<ArgsT extends DocumentArgs> = (ExpectedInputNonErrorClientDocumentBase & __NonErrorDocumentConstraintImpl<ArgsT & {
 ...
 *  @see {@link clientDocument}
 */
export declare type MappableInputNonErrorClientDocument<ArgsT extends DocumentArgs> = (MappableInputNonErrorClientDocumentBase & __NonErrorDocumentConstraintImpl<ArgsT & {
    resource: ExpectedInputClientResource;
}>);
/**
 *  @see {@link clientDocument}
 */
export declare type NonErrorClientDocumentMapper<ArgsT extends DocumentMapperArgs> = (FluentMapper<SafeMapper<NonErrorClientDocument<ToDocumentArgs<ArgsT>>> & ExpectedInput<ExpectedInputNonErrorClientDocument<ToExpectedInputDocumentArgs<ArgsT>>> & MappableInput<MappableInputNonErrorClientDocument<ToMappableInputDocumentArgs<ArgsT>>>>);
/**
 ...
 */
export declare function nonErrorClientDocument<ArgsT extends DocumentMapperArgs>(args: ArgsT): (NonErrorClientDocumentMapper<ArgsT>);
//# sourceMappingURL=non-error-client-document.d.ts.map